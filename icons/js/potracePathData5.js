...
function potraceBmp(bmp, {
    ...
    let svg = getSVG(bmp, pathlist, scale, returnPathData)
...
function getSVG(bmp, pathlist, scale, returnPathData = true) {

    let len = pathlist.length;
    let w = bmp.w * scale, h = bmp.h * scale;
    let pathData = []
